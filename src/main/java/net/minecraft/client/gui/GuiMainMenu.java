...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        Client.getInstance().getDiscordMYRPC().update("Idle", "Main Menu");
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        // SmartClient - Remove Realms Button
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        {
            // SmartClient - Remove switching to realms
        //    this.switchToRealms();
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = String.format("%s %s | %s", Main.instance.getName(),  Main.instance.getBuild(),  Main.instance.getVersion());
