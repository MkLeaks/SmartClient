...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public static GuiTextField IpBungeeBtn;
    ...
    // Why is the fucking color code broken, i hate this so much
    private String BungeeSpoofBtn() {
        return Main.BungeeHack ? "Bungee: " + ColorUtils.color + "aYes" : "Bungee: " + ColorUtils.color + "cNo";
    }
    ...
    public void initGui()
    {
        Client.getInstance().getDiscordMYRPC().update("Idle", "Multiplayer Menu");
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 8)
            {
                ...
                Main.BungeeHack = !Main.BungeeHack;
                button.displayString = BungeeSpoofBtn();
            }
            else if (button.id == 10) {
                mc.displayGuiScreen(new GuiTools(this));
            }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        if (keyCode == 15 && IpBungeeBtn.isFocused())
            IpBungeeBtn.setFocused(false);
        if (IpBungeeBtn.isFocused())
            IpBungeeBtn.textboxKeyTyped(typedChar, keyCode);
        ...
        else
        {
            ...
            Main.IpBungeeHack = IpBungeeBtn.getText();
        }
    }
    ...
    {
        IpBungeeBtn.mouseClicked(mouseX, mouseY, mouseButton);
